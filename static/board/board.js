...
(function () {
  ...
  // 30, а не 20: при 100% самый частый ряд тогда попадает в зону затухания и
  // еле виден, а привычной мелкой клеткой остаются 40 пикселей. С порогом 20
  // сетка при 100% выходила вдвое гуще.
  const GRID_MIN_PX = 30, GRID_MIN_PX_DOTS = 26;
