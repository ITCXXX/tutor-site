...
разбирать это до сих пор дорого. Здесь того же не повторяем: и страница урока,
и страница задачи, и переписка («спросить по задаче»), и ночная рассылка
напоминаний спрашивают у одной и той же функции.
