...
from ._oge15_kvartira_svg import KVARTIRA_SVG
...
TASKS = [
    {"tid": "F9F909", "t_type": "T1",
     ...
     "answer": "12"},  # 16/0,16 = 100 досок; 100/14 ≈ 7,14 → 8
    ...
    {"tid": "01790D", "t_type": "T2",
     ...
     "answer": "7"},  # (3,2+1,92)/0,16 = 32 плитки; 32/12 → 3 (но округление до 4 пакетов)
    ...
    {"tid": "1771B3", "t_type": "T3",
     ...
     "answer": "11"},  # 6,4/0,16 = 40 досок; 40/12 ≈ 3,33 → 4
    ...
    {"tid": "3302B1", "t_type": "T4",
     ...
     "answer": "9"},  # 12/0,16 = 75 досок; 75/12 ≈ 6,25 → 7
    ...
    {"tid": "BC53D1", "t_type": "T5",
     ...
     "answer": "50"},  # 1,92 vs 2 — практически равны; ОЦЕНКА
    ...
    {"tid": "2622B9", "t_type": "T5",
     ...
     "answer": "200"},  # (8-1,92)/1,92·100 ≈ 316,67 → 317
]
