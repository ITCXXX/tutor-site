...
def _parse_expr(s):
    """Рекурсивно парсит LaTeX-подстроку в float, возвращает (value, consumed_len).
...
def _parse_factor(s):
    """Парсит ОДИН фактор: число | \frac{}{} | \sqrt{}. Возвращает (value, used)."""
...
def _check_latex_canonical(s_norm):
    """Возвращает message или None, если форма канонична.
